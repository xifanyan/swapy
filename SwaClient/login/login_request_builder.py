...
class LoginRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/login", path_parameters)
    
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[bytes]:
        """
        Creates a new session. NOTE: all other endpoints implicitly create new sessions based on request headers as well. This method merely allows an explicit login without using side effects. The session id is returned as response header SWA-SESSION and must be provided to all following requests.
