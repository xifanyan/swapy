...
if TYPE_CHECKING:
    from .record_resource import RecordResource
    from .status_object import StatusObject

@dataclass
class RecordResourcesResult(APIError, AdditionalDataHolder, Parsable):
    ...
    results: Optional[list[RecordResource]] = None
    # The status of the response.
    status: Optional[StatusObject] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RecordResourcesResult:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: RecordResourcesResult
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return RecordResourcesResult()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "results": lambda n : setattr(self, 'results', n.get_collection_of_object_values(RecordResource)),
