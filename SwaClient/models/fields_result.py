...
@dataclass
class FieldsResult(APIError, AdditionalDataHolder, Parsable):
    ...
    results: Optional[list[FieldDescription]] = None
    # The status of the response.
    status: Optional[StatusObject] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> FieldsResult:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: FieldsResult
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "results": lambda n : setattr(self, 'results', n.get_collection_of_object_values(FieldDescription)),
